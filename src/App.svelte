<script lang="ts">
    ...
    import { mdiWindowClose, mdiAccountQuestion, mdiFileDocumentMultiple, mdiCardAccountDetails } from "@mdi/js";
...
<main>
    <div class="h-screen w-screen flex flex-col gap-5 items-center justify-center relative">
		...
		<div class="bg-container-dark rounded-lg flex overflow-hidden w-1/2 divide-x divide-slate-600 text-center font-bold">
			<div class="flex-1 p-3 hover:bg-container-hover transition">
				<button class="flex flex-row items-center justify-center w-full gap-3">
